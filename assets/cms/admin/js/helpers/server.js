...
const Server = new ServerHelper({
    ...
    error: (options, error, data) => {
        ...
        if (get(error, 'response.request.status') === 403) {
            Server.notification.danger(Server.lang.get('errors.general'));
            ...
            Server.notification.warning(Server.lang.get('errors.post_too_large'));
            ...
            if (options.formHelper) {
                ...
                Server.notification.warning(Server.lang.get('inputs.message_error_fields'));
            }

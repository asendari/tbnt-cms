...
class DateFormatUtils
{
     ...
     */
    public static function date_format_to(string $format, string $syntax)
    {
     ...
     * @return string
     */
    public static function strftime_format_to_date_format(string $strf_format)
    {
     ...
     * @return string
     */
    public static function date_format_to_strftime_format(string $date_format)
    {
